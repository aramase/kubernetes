...
func TestValidateClaimMappings(t *testing.T) {
 ...
 | ^]`,
		...
		{
			name: "duplicate extra mapping key and value expression",
			in: api.ClaimMappings{
			...
			structuredAuthnFeatureEnabled: true,
			want:                          `issuer.claimMappings.extra[1]: Duplicate value: "key: example.org/foo, valueExpression: claims.extra"`,
		},
		{
