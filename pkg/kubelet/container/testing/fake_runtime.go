...
func (f *FakeRuntime) PullImage(ctx context.Context, image kubecontainer.ImageSpec, pullSecrets []v1.Secret, pod *v1.Pod, sa *v1.ServiceAccount, podSandboxConfig *runtimeapi.PodSandboxConfig) (string, error) {
	f.Lock()
