...
type ImageService interface {
	...
	PullImage(ctx context.Context, image ImageSpec, pullSecrets []v1.Secret, pod *v1.Pod, serviceAccount *v1.ServiceAccount, podSandboxConfig *runtimeapi.PodSandboxConfig) (string, error)
