...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*configv1beta1.ServiceAccountTokenAttributes)(nil), (*config.ServiceAccountTokenAttributes)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta1_ServiceAccountTokenAttributes_To_config_ServiceAccountTokenAttributes(a.(*configv1beta1.ServiceAccountTokenAttributes), b.(*config.ServiceAccountTokenAttributes), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.ServiceAccountTokenAttributes)(nil), (*configv1beta1.ServiceAccountTokenAttributes)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_ServiceAccountTokenAttributes_To_v1beta1_ServiceAccountTokenAttributes(a.(*config.ServiceAccountTokenAttributes), b.(*configv1beta1.ServiceAccountTokenAttributes), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_config_CredentialProvider_To_v1beta1_CredentialProvider(in *config.CredentialProvider, out *configv1beta1.CredentialProvider, s conversion.Scope) error {
	...
	out.TokenAttributes = (*configv1beta1.ServiceAccountTokenAttributes)(unsafe.Pointer(in.TokenAttributes))
	return nil
}
...
func autoConvert_v1beta1_ServiceAccountTokenAttributes_To_config_ServiceAccountTokenAttributes(in *configv1beta1.ServiceAccountTokenAttributes, out *config.ServiceAccountTokenAttributes, s conversion.Scope) error {
...
// Convert_v1beta1_ServiceAccountTokenAttributes_To_config_ServiceAccountTokenAttributes is an autogenerated conversion function.
func Convert_v1beta1_ServiceAccountTokenAttributes_To_config_ServiceAccountTokenAttributes(in *configv1beta1.ServiceAccountTokenAttributes, out *config.ServiceAccountTokenAttributes, s conversion.Scope) error {
	return autoConvert_v1beta1_ServiceAccountTokenAttributes_To_config_ServiceAccountTokenAttributes(in, out, s)
}

func autoConvert_config_ServiceAccountTokenAttributes_To_v1beta1_ServiceAccountTokenAttributes(in *config.ServiceAccountTokenAttributes, out *configv1beta1.ServiceAccountTokenAttributes, s conversion.Scope) error {
	out.ServiceAccountTokenAudience = in.ServiceAccountTokenAudience
	out.ServiceAccountAnnotationKeys = *(*[]string)(unsafe.Pointer(&in.ServiceAccountAnnotationKeys))
	return nil
}

// Convert_config_ServiceAccountTokenAttributes_To_v1beta1_ServiceAccountTokenAttributes is an autogenerated conversion function.
func Convert_config_ServiceAccountTokenAttributes_To_v1beta1_ServiceAccountTokenAttributes(in *config.ServiceAccountTokenAttributes, out *configv1beta1.ServiceAccountTokenAttributes, s conversion.Scope) error {
	return autoConvert_config_ServiceAccountTokenAttributes_To_v1beta1_ServiceAccountTokenAttributes(in, out, s)
}
