...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*configv1alpha1.ImagePullServiceAccountTokenSource)(nil), (*config.ImagePullServiceAccountTokenSource)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_ImagePullServiceAccountTokenSource_To_config_ImagePullServiceAccountTokenSource(a.(*configv1alpha1.ImagePullServiceAccountTokenSource), b.(*config.ImagePullServiceAccountTokenSource), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.ImagePullServiceAccountTokenSource)(nil), (*configv1alpha1.ImagePullServiceAccountTokenSource)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_ImagePullServiceAccountTokenSource_To_v1alpha1_ImagePullServiceAccountTokenSource(a.(*config.ImagePullServiceAccountTokenSource), b.(*configv1alpha1.ImagePullServiceAccountTokenSource), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_ImagePullCredentials_To_config_ImagePullCredentials(in *configv1alpha1.ImagePullCredentials, out *config.ImagePullCredentials, s conversion.Scope) error {
	...
	out.ServiceAccountTokenSources = *(*[]config.ImagePullServiceAccountTokenSource)(unsafe.Pointer(&in.ServiceAccountTokenSources))
	return nil
}
...
func autoConvert_config_ImagePullCredentials_To_v1alpha1_ImagePullCredentials(in *config.ImagePullCredentials, out *configv1alpha1.ImagePullCredentials, s conversion.Scope) error {
	...
	out.NodePodsAccessible = in.NodePodsAccessible
	out.ServiceAccountTokenSources = *(*[]configv1alpha1.ImagePullServiceAccountTokenSource)(unsafe.Pointer(&in.ServiceAccountTokenSources))
	return nil
}
...
func autoConvert_v1alpha1_ImagePullServiceAccountTokenSource_To_config_ImagePullServiceAccountTokenSource(in *configv1alpha1.ImagePullServiceAccountTokenSource, out *config.ImagePullServiceAccountTokenSource, s conversion.Scope) error {
	...
	out.CacheType = in.CacheType
	return nil
}

// Convert_v1alpha1_ImagePullServiceAccountTokenSource_To_config_ImagePullServiceAccountTokenSource is an autogenerated conversion function.
func Convert_v1alpha1_ImagePullServiceAccountTokenSource_To_config_ImagePullServiceAccountTokenSource(in *configv1alpha1.ImagePullServiceAccountTokenSource, out *config.ImagePullServiceAccountTokenSource, s conversion.Scope) error {
	return autoConvert_v1alpha1_ImagePullServiceAccountTokenSource_To_config_ImagePullServiceAccountTokenSource(in, out, s)
}

func autoConvert_config_ImagePullServiceAccountTokenSource_To_v1alpha1_ImagePullServiceAccountTokenSource(in *config.ImagePullServiceAccountTokenSource, out *configv1alpha1.ImagePullServiceAccountTokenSource, s conversion.Scope) error {
	out.Audience = in.Audience
	out.Namespace = in.Namespace
	out.ServiceAccountName = in.ServiceAccountName
	out.ServiceAccountUID = in.ServiceAccountUID
...
// Convert_config_ImagePullServiceAccountTokenSource_To_v1alpha1_ImagePullServiceAccountTokenSource is an autogenerated conversion function.
func Convert_config_ImagePullServiceAccountTokenSource_To_v1alpha1_ImagePullServiceAccountTokenSource(in *config.ImagePullServiceAccountTokenSource, out *configv1alpha1.ImagePullServiceAccountTokenSource, s conversion.Scope) error {
	return autoConvert_config_ImagePullServiceAccountTokenSource_To_v1alpha1_ImagePullServiceAccountTokenSource(in, out, s)
}
