...
func NewWatchingServiceAccountManager(kubeClient clientset.Interface, resyncInterval time.Duration) Manager {
	...
	return &serviceAccountManager{
		manager: manager.NewWatchBasedManager(listServiceAccount, watchServiceAccount, newServiceAccount, isImmutable, gr, resyncInterval, getServiceAccountName),
	}
}
